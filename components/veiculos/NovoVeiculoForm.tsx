...
const [versaoLivre, setVersaoLivre] = useState(false);
...
await enviarFotos(inserido.id, fotos);
setLoading(false);
...
placeholder="Detalhes, opcionais, estado de conservação..."
/>
</div>
